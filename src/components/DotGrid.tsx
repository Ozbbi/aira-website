"use client";
/* DotGrid — interactive canvas dot field, adapted from reactbits.dev (MIT) for AIRA. */
...
export default function DotGrid({
  ...
  return (
    <section className={className} style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", width: "100%", position: "relative", ...style }}>
