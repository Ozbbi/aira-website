    ...
    <main className="relative w-full overflow-x-hidden bg-aira-bg text-aira-text">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 md:pt-40 pb-24">
        ...
        <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-6 text-[18px] md:text-[20px] text-aira-muted max-w-2xl leading-relaxed">
            ...
            <p className="mt-6 text-xs text-aira-dim">
      ...
      <section className="relative py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <p className="mt-10 max-w-3xl mx-auto text-center text-aira-text text-base md:text-lg leading-relaxed">
      ...
      <section className="relative py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center" style={headingFont}>
            Why AIRA?
          </h2>
